...
void conv2d_1() {
    ...
    static const int padded_size = input_size + 2 * conv2d_1_kernel_padding;
    ...
    //Print kernel in first kernel and channel
    // for (int k = 0; k < 1; k++){
    //     printf("Kernel %d\n", k);
    //     for (int l = 0; l < 1; l++){
    //         printf("Channel %d\n", l);
    //         for (int i = 0; i < conv2d_1_kernel_size; i++) {
    //             for (int j = 0; j < conv2d_1_kernel_size; j++) {
    //                 printf("%d ", conv2d_1_kernel[i][j][l][k]);
    //             }
    //             printf("\n");
    //         }
    //     }
...
void depthwiseconv2d_1(){
    ...
    static const int conv2d_1_output_padded_size = conv2d_1_output_size + 2 * depthwiseconv2d_1_kernel_padding;
...
void depthwiseconv2d_2(){
    ...
    static const int conv2d_2_output_padded_size = conv2d_2_output_size + 2*depthwiseconv2d_2_kernel_padding;
...
void depthwiseconv2d_3(){
    ...
    static const int padded_conv2d_3_output_size = conv2d_3_output_size + depthwiseconv2d_3_kernel_padding*2;
...
void depthwiseconv2d_4(){
    ...
    static const int conv2d_4_output_padded_size = conv2d_4_output_size + depthwiseconv2d_4_kernel_padding * 2;
...
void depthwiseconv2d_5(){
    ...
    static const int conv2d_5_padded_output_size = depthwiseconv2d_5_output_size + 2*depthwiseconv2d_1_kernel_padding;
...
void depthwiseconv2d_6(){
    ...
    static const int conv2d_6_output_padded_size = conv2d_6_output_size + 2*depthwiseconv2d_6_kernel_padding;
...
void depthwiseconv2d_7(){
    ...
    static const int conv2d_7_output_padded_size = conv2d_7_output_size + 2*depthwiseconv2d_7_kernel_padding;
...
void depthwiseconv2d_8_bonus(){
    ...
    static const int conv2d_8_bonus_padded_output_size = conv2d_8_bonus_output_size + 2 * depthwiseconv2d_8_kernel_padding;
...
void depthwiseconv2d_8(){
    ...
    static const int conv2d_8_output_padded_size = conv2d_8_output_size + depthwiseconv2d_8_kernel_padding*2;
...
void depthwiseconv2d_9(){
    ...
    static const int conv2d_9_output_padded_size = conv2d_9_output_size + depthwiseconv2d_9_kernel_padding * 2;
...
void depthwiseconv2d_10(){
    ...
    static const int conv2d_10_output_padded_size = conv2d_10_output_size + 2 * depthwiseconv2d_10_kernel_padding;
...
void depthwiseconv2d_11(){
    ...
    static const int conv2d_11_output_padded_size = conv2d_11_output_size + depthwiseconv2d_11_kernel_padding * 2;
...
void depthwiseconv2d_12(){
    ...
    static const int conv2d_12_output_padded_size = conv2d_12_output_size + depthwiseconv2d_12_kernel_padding * 2;
...
void depthwiseconv2d_13(){
    ...
    static const int conv2d_13_output_padded_size = conv2d_13_output_size + depthwiseconv2d_13_kernel_padding * 2;
...
void depthwiseconv2d_14(){
    ...
    static const int conv2d_14_output_padded_size = conv2d_14_output_size + depthwiseconv2d_14_kernel_padding * 2;
