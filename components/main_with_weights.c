...
#define conv2d_9_output_scale 0.05946462228894234 
...
void dw1(){
    ...
    for (int k = 0; k < dw1_output_size; k++){
        for (int i = 0; i < dw1_output_size; i++) {
            for (int j = 0; j < dw1_weights_channels; j++) {
    ...
    // Perform dw1
    for (int k = 0; k < dw1_weights_num; k++){
        for (int i = 0; i < dw1_output_size; i++) {
            for (int j = 0; j < dw1_output_size; j++) {
                for (int l = 0; l < dw1_weights_channels; l++) {
                    ...
                    dw1_output_32[i][j][l] += dw1_biases[l];
                    dw1_output_32[i][j][l] = fixed_point_multipilier(dw1_output_32[i][j][l], dw1_fraction_int32, dw1_exponent);

                    dw1_output[i][j][l] = (uint8_t)(dw1_output_32[i][j][l]);

                    //Add zero point to dw1_output
                    dw1_output[i][j][l] -= dw1_output_zero_point;

                    //Saturate
                    if (dw1_output[i][j][l] > 255){
                        dw1_output[i][j][l] = 255;
                    }
                    else if (dw1_output[i][j][l] < 0){
                        dw1_output[i][j][l] = 0;
                    }
                }
            }
            ...
            for (int j = 0; j < dw3_output_size; j++) {
                ...
                for (int l = 0; l < dw3_weights_size; l++) {
                    for (int m = 0; m < dw3_weights_size; m++) {
                        dw3_output_32[i][j][k] += padded_conv2d_3_output[i*dw3_weights_stride + l][j*dw3_weights_stride + m][k] * dw3_weights[l][m][k][0];
                    }
                }
...
void pw3(){
    ...
    printf("First element of pw3_weights: %d\n", pw3_weights[0][0][0][0]);
    printf("Second element of pw3_weights: %d\n", pw3_weights[0][0][0][1]);
            ...
            for (int j = 0; j < dw4_output_size; j++) {
                ...
                for (int l = 0; l < dw4_weights_size; l++) {
                    for (int m = 0; m < dw4_weights_size; m++) {
                        dw4_output_32[i][j][k] += conv2d_4_output_padded[i*dw4_weights_stride + l][j*dw4_weights_stride + m][k] * dw4_weights[l][m][k][0];
                    }
                }
...
void pw4(){
    ...
    // Calculate the normalized pw4_multiplier
    const float pw4_multiplier = dw4_output_scale * pw4_weights_scale / pw4_output_scale;

    // Normalized fraction and exponent the pw4_multiplier
    float pw4_fraction;
    int pw4_exponent;
    frexp_function(pw4_multiplier, &pw4_fraction, &pw4_exponent);
    int pw4_fraction_int32 = pw4_fraction * (1ll << 31);
    printf("pw4_multiplier = %f = %d * 2^%d\n", pw4_multiplier, pw4_fraction_int32, pw4_exponent);

    int32_t pw4_output_32[pw4_output_size][pw4_output_size][pw4_weights_num];

    printf("First element of pw4_weights: %d\n", pw4_weights[0][0][0][0]);
    printf("Second element of pw4_weights: %d\n", pw4_weights[0][0][0][1]);
    
    // Perform pw4
    for (int k = 0; k < pw4_weights_num; k++) {
        for (int i = 0; i < pw4_output_size; i++) {
            for (int j = 0; j < pw4_output_size; j++) {
                pw4_output_32[i][j][k] = 0;
                for (int l = 0; l < pw4_weights_channels; l++) {
                    for (int m = 0; m < pw4_weights_size; m++) {
                        for (int n = 0; n < pw4_weights_size; n++) {
                            pw4_output_32[i][j][k] += dw4_output[i][j][l] * pw4_weights[m][n][l][k];
                        }
                    }
                }
                pw4_output_32[i][j][k] += pw4_biases[k];

                pw4_output_32[i][j][k] = fixed_point_multipilier(pw4_output_32[i][j][k], pw4_fraction_int32, pw4_exponent);

                // Cast to uint8_t
                pw4_output[i][j][k] = (uint8_t)pw4_output_32[i][j][k];

                // Add zero point
                pw4_output[i][j][k] = pw4_output[i][j][k] - pw4_output_zero_point;

                // Saturate
                if (pw4_output[i][j][k] < 0) {
                    pw4_output[i][j][k] = 0;
                } else if (pw4_output[i][j][k] > 255) {
                    pw4_output[i][j][k] = 255;
                }
            }
        }
    }
    printf("First element of pw4_output_32: %d\n", pw4_output_32[0][0][0]);
    printf("Second element of pw4_output_32: %d\n", pw4_output_32[1][0][0]);
    printf("First element of pw4_output: %d\n", pw4_output[0][0][0]);
    printf("Second element of pw4_output: %d\n", pw4_output[1][0][0]);
    printf("Size of pw4_output: %d x %d x %d \n\n", LEN(pw4_output), LEN(pw4_output[0]), LEN(pw4_output[0][0]));
}

void conv2d_5(){

    // Calculate the normalized conv2d_5_multiplier
    const float conv2d_5_multiplier = pw4_output_scale * conv2d_5_weights_scale / conv2d_5_output_scale;

    // Normalized fraction and exponent the conv2d_5_multiplier
    float conv2d_5_fraction;
    int conv2d_5_exponent;
    frexp_function(conv2d_5_multiplier, &conv2d_5_fraction, &conv2d_5_exponent);
    int conv2d_5_fraction_int32 = conv2d_5_fraction * (1ll << 31);
    printf("conv2d_5_multiplier = %f = %d * 2^%d\n", conv2d_5_multiplier, conv2d_5_fraction_int32, conv2d_5_exponent);

    int32_t conv2d_5_output_32[conv2d_5_output_size][conv2d_5_output_size][conv2d_5_weights_num];

    printf("First element of conv2d_5_weights: %d\n", conv2d_5_weights[0][0][0][0]);
    printf("Second element of conv2d_5_weights: %d\n", conv2d_5_weights[0][0][0][1]);

    //Perform conv2d_5
    for(int k = 0; k < conv2d_5_weights_num; k++){
        for(int i = 0; i < conv2d_5_output_size; i++){
            for(int j = 0; j < conv2d_5_output_size; j++){
                conv2d_5_output_32[i][j][k] = 0;
                for(int l = 0; l < conv2d_5_weights_channels; l++){
                    for(int m = 0; m < conv2d_5_weights_size; m++){
                        for(int n = 0; n < conv2d_5_weights_size; n++){
                            conv2d_5_output_32[i][j][k] += pw4_output[i*conv2d_5_weights_stride + m][j*conv2d_5_weights_stride + n][l] * conv2d_5_weights[m][n][l][k];
                        }
                    }
                }
                conv2d_5_output_32[i][j][k] += conv2d_5_biases[k];

                conv2d_5_output_32[i][j][k] = fixed_point_multipilier(conv2d_5_output_32[i][j][k], conv2d_5_fraction_int32, conv2d_5_exponent);

                // Cast to uint8_t
                conv2d_5_output[i][j][k] = (uint8_t)conv2d_5_output_32[i][j][k];

                // Add zero point
                conv2d_5_output[i][j][k] = conv2d_5_output[i][j][k] - conv2d_5_output_zero_point;

                // Saturate
                if (conv2d_5_output[i][j][k] < 0) {
                    conv2d_5_output[i][j][k] = 0;
                } else if (conv2d_5_output[i][j][k] > 255) {
                    conv2d_5_output[i][j][k] = 255;
                }
            }
        }
    }
    printf("First element of conv2d_5_output_32: %d\n", conv2d_5_output_32[0][0][0]);
    printf("Second element of conv2d_5_output_32: %d\n", conv2d_5_output_32[1][0][0]);
    printf("First element of conv2d_5_output: %d\n", conv2d_5_output[0][0][0]);
    printf("Second element of conv2d_5_output: %d\n", conv2d_5_output[1][0][0]);
    printf("Size of conv2d_5_output: %d x %d x %d \n\n", LEN(conv2d_5_output), LEN(conv2d_5_output[0]), LEN(conv2d_5_output[0][0]));
}

void dw5(){

    // Calculate the normalized dw5_multiplier
    const float dw5_multiplier = conv2d_5_output_scale * dw5_weights_scale / dw5_output_scale;

    // Normalized fraction and exponent the dw5_multiplier
    float dw5_fraction;
    int dw5_exponent;
    frexp_function(dw5_multiplier, &dw5_fraction, &dw5_exponent);
    int dw5_fraction_int32 = dw5_fraction * (1ll << 31);
    printf("dw5_multiplier = %f = %d * 2^%d\n", dw5_multiplier, dw5_fraction_int32, dw5_exponent);

    int32_t dw5_output_32[dw5_output_size][dw5_output_size][dw5_weights_channels];

    // Initialize padded dw5_output_32 with 0
    for(int i = 0; i < dw5_output_size; i++){
        for(int j = 0; j < dw5_output_size; j++){
            for(int k = 0; k < dw5_weights_channels; k++){
                dw5_output_32[i][j][k] = 0;
            }
        }
    }

    printf("First element of dw5_weights: %d\n", dw5_weights[0][0][0][0]);
    printf("Second element of dw5_weights: %d\n", dw5_weights[0][0][0][1]);
    ...
    //Perform dw5
    for (int k = 0; k < dw5_weights_num; k++){
        for(int i = 0; i < dw5_output_size; i++){
            for(int j = 0; j < dw5_output_size; j++){
                for(int l = 0; l < dw5_weights_channels; l++){
                    for(int m = 0; m < dw5_weights_size; m++){
                        for(int n = 0; n < dw5_weights_size; n++){
                            dw5_output_32[i][j][l] += conv2d_5_padded_output[i*dw5_weights_stride + m][j*dw5_weights_stride + n][l] * dw5_weights[m][n][l][0];
                        }
                    }
                    dw5_output_32[i][j][l] += dw5_biases[l];

                    dw5_output_32[i][j][l] = fixed_point_multipilier(dw5_output_32[i][j][l], dw5_fraction_int32, dw5_exponent);

                    // Cast to uint8_t
                    dw5_output[i][j][l] = (uint8_t)dw5_output_32[i][j][l];

                    // Add zero point 
                    dw5_output[i][j][l] = dw5_output[i][j][l] - dw5_output_zero_point;

                    // Saturate
                    if (dw5_output[i][j][l] < 0) {
                        dw5_output[i][j][l] = 0;
                    } else if (dw5_output[i][j][l] > 255) {
                        dw5_output[i][j][l] = 255;
                    }
                }
            }
        }
    }
    printf("First element of dw5_output_32: %d\n", dw5_output_32[0][0][0]);
    printf("Second element of dw5_output_32: %d\n", dw5_output_32[1][0][0]);
    printf("First element of dw5_output: %d\n", dw5_output[0][0][0]);
    printf("Second element of dw5_output: %d\n", dw5_output[1][0][0]);
    printf("Size of dw5_output: %d x %d x %d \n\n", LEN(dw5_output), LEN(dw5_output[0]), LEN(dw5_output[0][0]));
}

void pw5(){
    // Calculate the normalized pw5_multiplier
    const float pw5_multiplier = dw5_output_scale * pw5_weights_scale / pw5_output_scale;

    // Normalized fraction and exponent the pw5_multiplier
    float pw5_fraction;
    int pw5_exponent;
    frexp_function(pw5_multiplier, &pw5_fraction, &pw5_exponent);
    int pw5_fraction_int32 = pw5_fraction * (1ll << 31);
    printf("pw5_multiplier = %f = %d * 2^%d\n", pw5_multiplier, pw5_fraction_int32, pw5_exponent);

    int32_t pw5_output_32[dw5_output_size][dw5_output_size][pw5_weights_num];

    printf("Size of pw5_output_32: %d x %d x %d \n", LEN(pw5_output_32), LEN(pw5_output_32[0]), LEN(pw5_output_32[0][0]));

    // Perform pw5
    for(int k = 0; k < pw5_weights_num; k++){
        for(int i = 0; i < dw5_output_size; i++){
            for(int j = 0; j < dw5_output_size; j++){
                pw5_output_32[i][j][k] = 0;
                for(int l = 0; l < pw5_weights_channels; l++){
                    for(int m = 0; m < pw5_weights_size; m++){
                        for(int n = 0; n < pw5_weights_size; n++){
                            pw5_output_32[i][j][k] += dw5_output[i*pw5_weights_stride + m][j*pw5_weights_stride + n][l] * pw5_weights[m][n][l][k];
                        }
                    }
                }
                pw5_output_32[i][j][k] += pw5_biases[k];

                pw5_output_32[i][j][k] = fixed_point_multipilier(pw5_output_32[i][j][k], pw5_fraction_int32, pw5_exponent);

                // Cast to uint8_t
                pw5_output[i][j][k] = (uint8_t)pw5_output_32[i][j][k];

                // Add zero point
                pw5_output[i][j][k] = pw5_output[i][j][k] - pw5_output_zero_point;

                // Saturate
                if (pw5_output[i][j][k] < 0) {
                    pw5_output[i][j][k] = 0;
                } else if (pw5_output[i][j][k] > 255) {
                    pw5_output[i][j][k] = 255;
                }
            }
        }
    }
    printf("First element of pw5_output_32: %d\n", pw5_output_32[0][0][0]);
    printf("Second element of pw5_output_32: %d\n", pw5_output_32[1][0][0]);
    printf("First element of pw5_output: %d\n", pw5_output[0][0][0]);
    printf("Second element of pw5_output: %d\n", pw5_output[1][0][0]);
...
void add_3(){
    ...
    // Calculate the input and output new scale
    const float add_3_input_1_scale = 0.5;
    const int add_3_input_1_zero_point = pw4_output_zero_point;
    const float add_3_input_2_scale = pw5_output_scale/ (2 * pw4_output_scale);
    const int add_3_input_2_zero_point = pw5_output_zero_point;
    const float add_3_output_scale_new = 2 * pw4_output_scale / add_3_output_scale;


    // Normalized fraction and exponent the add_3_input_1_scale
    float add_3_input_1_scale_fraction;
    int add_3_input_1_scale_exponent;
    frexp_function(add_3_input_1_scale, &add_3_input_1_scale_fraction, &add_3_input_1_scale_exponent);
    int add_3_input_1_scale_fraction_int32 = add_3_input_1_scale_fraction * (1ll << 31);
    printf("add_3_input_1_scale = %f = %d * 2^%d\n", add_3_input_1_scale, add_3_input_1_scale_fraction_int32, add_3_input_1_scale_exponent);

    // Normalized fraction and exponent the add_3_input_2_scale
    float add_3_input_2_scale_fraction;
    int add_3_input_2_scale_exponent;
    frexp_function(add_3_input_2_scale, &add_3_input_2_scale_fraction, &add_3_input_2_scale_exponent);
    int add_3_input_2_scale_fraction_int32 = add_3_input_2_scale_fraction * (1ll << 31);
    printf("add_3_input_2_scale = %f = %d * 2^%d\n", add_3_input_2_scale, add_3_input_2_scale_fraction_int32, add_3_input_2_scale_exponent);

    // Normalized fraction and exponent the add_3_output_scale_new
    float add_3_output_scale_new_fraction;
    int add_3_output_scale_new_exponent;    
    frexp_function(add_3_output_scale_new / (1 << 20), &add_3_output_scale_new_fraction, &add_3_output_scale_new_exponent);
    int add_3_output_scale_new_fraction_int32 = add_3_output_scale_new_fraction * (1ll << 31);
    printf("add_3_output_scale_new = %f = %d * 2^%d\n", add_3_output_scale_new, add_3_output_scale_new_fraction_int32, add_3_output_scale_new_exponent);

    // Define size of add_3_input_1, add_3_input_2, add_3_output_32
    int32_t add_3_input_1[add_3_output_size][add_3_output_size][add_3_output_channels];
    int32_t add_3_input_2[add_3_output_size][add_3_output_size][add_3_output_channels];
    int32_t add_3_output_32[add_3_output_size][add_3_output_size][add_3_output_channels];

    // Copy value of previous layers into add_3_input_1 and add_3_input_2
    for(int i = 0; i < add_3_output_size; i++){
        for(int j = 0; j < add_3_output_size; j++){
            for(int k = 0; k < add_3_output_channels; k++){
                add_3_input_1[i][j][k] = pw4_output[i][j][k];
                add_3_input_2[i][j][k] = pw5_output[i][j][k];
            }
        }
    }

    printf("add_3_input_1[%d][%d][%d] = %d\n", 0, 0, 0, add_3_input_1[0][0][0]);
    printf("add_3_input_1[%d][%d][%d] = %d\n", 1, 0, 0, add_3_input_1[1][0][0]);

    printf("add_3_input_2[%d][%d][%d] = %d\n", 0, 0, 0, add_3_input_2[0][0][0]);
    printf("add_3_input_2[%d][%d][%d] = %d\n", 1, 0, 0, add_3_input_2[1][0][0]);
    ...
    for(int i = 0; i < add_3_output_size; i++){
        for(int j = 0; j < add_3_output_size; j++){
            for(int k = 0; k < add_3_output_channels; k++){
                ...
                // Add zero point
                add_3_input_1[i][j][k] += add_3_input_1_zero_point;
                add_3_input_2[i][j][k] += add_3_input_2_zero_point;

                // Left shift the input
                add_3_input_1[i][j][k] = add_3_input_1[i][j][k] * (1 << 20);
                add_3_input_2[i][j][k] = add_3_input_2[i][j][k] * (1 << 20);

                // Fixed point multiplier
                add_3_input_1[i][j][k] = fixed_point_multipilier(add_3_input_1[i][j][k], add_3_input_1_scale_fraction_int32, add_3_input_1_scale_exponent);
                add_3_input_2[i][j][k] = fixed_point_multipilier(add_3_input_2[i][j][k], add_3_input_2_scale_fraction_int32, add_3_input_2_scale_exponent);
                add_3_output_32[i][j][k] = add_3_input_1[i][j][k] + add_3_input_2[i][j][k];

                // Fixed point multiplier
                add_3_output_32[i][j][k] = fixed_point_multipilier(add_3_output_32[i][j][k], add_3_output_scale_new_fraction_int32, add_3_output_scale_new_exponent);

                // Add zero point to add_3_output
                add_3_output_32[i][j][k] -= add_3_output_zero_point;

                // Saturate the output
                add_3_output[i][j][k] = saturate(add_3_output_32[i][j][k]);
            }
        }
    }
    printf("First element of add_3_output_32: %d\n", add_3_output_32[0][0][0]);
    printf("Second element of add_3_output_32: %d\n", add_3_output_32[1][0][0]);
    printf("First element of add_3_output: %d\n", add_3_output[0][0][0]);
    printf("Second element of add_3_output: %d\n", add_3_output[1][0][0]);
    printf("Size of add_3_output: %d x %d x %d \n\n", LEN(add_3_output), LEN(add_3_output[0]), LEN(add_3_output[0][0]));
}

void conv2d_6(){

    // Calculate the normalized conv2d_6_multiplier
    const float conv2d_6_multiplier = conv2d_6_weights_scale * add_3_output_scale / conv2d_6_output_scale;

    // Normalized fraction and exponent the conv2d_6_multiplier
    float conv2d_6_fraction;
    int conv2d_6_exponent;
    frexp_function(conv2d_6_multiplier, &conv2d_6_fraction, &conv2d_6_exponent);
    int conv2d_6_fraction_int32 = conv2d_6_fraction * (1ll << 31);
    printf("conv2d_6_multiplier = %f = %d * 2^%d\n", conv2d_6_multiplier, conv2d_6_fraction_int32, conv2d_6_exponent);

    int32_t conv2d_6_output_32[conv2d_6_output_size][conv2d_6_output_size][conv2d_6_weights_num];

    printf("First element of conv2d_6_weights: %d\n", conv2d_6_weights[0][0][0][0]);
    printf("Second element of conv2d_6_weights: %d\n", conv2d_6_weights[0][0][0][1]);

    // Perform conv2d_6
    for(int k = 0; k < conv2d_6_weights_num; k++){
        for(int i = 0; i < add_3_output_size; i++){
            for(int j = 0; j < add_3_output_size; j++){
                conv2d_6_output_32[i][j][k] = 0;
                for(int l = 0; l < conv2d_6_weights_channels; l++){
                    for(int m = 0; m < conv2d_6_weights_size; m++){
                        for(int n = 0; n < conv2d_6_weights_size; n++){
                            conv2d_6_output_32[i][j][k] += add_3_output[i*conv2d_6_weights_stride + m][j*conv2d_6_weights_stride + n][l] * conv2d_6_weights[m][n][l][k];
                        }
                    }
                    conv2d_6_output_32[i][j][k] += conv2d_6_biases[k];

                    conv2d_6_output_32[i][j][k] = fixed_point_multipilier(conv2d_6_output_32[i][j][k], conv2d_6_fraction_int32, conv2d_6_exponent);

                    // Cast to uint8_t
                    conv2d_6_output[i][j][k] = (uint8_t)conv2d_6_output_32[i][j][k];

                    // Add zero point
                    conv2d_6_output[i][j][k] = conv2d_6_output[i][j][k] - conv2d_6_output_zero_point;

                    // Saturate
                    if (conv2d_6_output[i][j][k] < 0) {
                        conv2d_6_output[i][j][k] = 0;
                    } else if (conv2d_6_output[i][j][k] > 255) {
                        conv2d_6_output[i][j][k] = 255;
                    }
                }
            }
        }
    }
    printf("First element of conv2d_6_output_32: %d\n", conv2d_6_output_32[0][0][0]);
    printf("Second element of conv2d_6_output_32: %d\n", conv2d_6_output_32[1][0][0]);
    printf("First element of conv2d_6_output: %d\n", conv2d_6_output[0][0][0]);
    printf("Second element of conv2d_6_output: %d\n", conv2d_6_output[1][0][0]);
    printf("Size of conv2d_6_output: %d x %d x %d \n\n", LEN(conv2d_6_output), LEN(conv2d_6_output[0]), LEN(conv2d_6_output[0][0]));
}

void dw6(){

    // Calculate the normalized dw6_multiplier
    const float dw6_multiplier = conv2d_6_output_scale * dw6_weights_scale / dw6_output_scale;

    // Normalized fraction and exponent the dw6_multiplier
    float dw6_fraction;
    int dw6_exponent;
    frexp_function(dw6_multiplier, &dw6_fraction, &dw6_exponent);
    int dw6_fraction_int32 = dw6_fraction * (1ll << 31);
    printf("dw6_multiplier = %f = %d * 2^%d\n", dw6_multiplier, dw6_fraction_int32, dw6_exponent);

    int32_t dw6_output_32[dw6_output_size][dw6_output_size][dw6_weights_channels];

    printf("First element of dw6_weights: %d\n", dw6_weights[0][0][0][0]);
    printf("Second element of dw6_weights: %d\n", dw6_weights[0][0][0][1]);
    ...
    for(int k = 0; k < dw6_weights_channels; k++){
        for(int i = 0; i < conv2d_6_output_size; i++){
            for(int j = 0; j < conv2d_6_output_size; j++){
                dw6_output_32[i][j][k] = 0;
                for(int l = 0; l < dw6_weights_size; l++){
                    for(int m = 0; m < dw6_weights_size; m++){
                        dw6_output_32[i][j][k] += conv2d_6_output_padded[i*dw6_weights_stride + l][j*dw6_weights_stride + m][k] * dw6_weights[l][m][k][0];
                    }
                }
                dw6_output_32[i][j][k] += dw6_biases[k];

                dw6_output_32[i][j][k] = fixed_point_multipilier(dw6_output_32[i][j][k], dw6_fraction_int32, dw6_exponent);

                // Cast to uint8_t
                dw6_output[i][j][k] = (uint8_t)dw6_output_32[i][j][k];

                // Add zero point 
                dw6_output[i][j][k] = dw6_output[i][j][k] - dw6_output_zero_point;

                // Saturate
                if (dw6_output[i][j][k] < 0) {
                    dw6_output[i][j][k] = 0;
                } else if (dw6_output[i][j][k] > 255) {
                    dw6_output[i][j][k] = 255;
                }
                // printf("dw6_output[%d][%d][%d] = %d\n", i, j, k, dw6_output[i][j][k]);
            }
        }
    }
    printf("First element of dw6_output_32: %d\n", dw6_output_32[0][0][0]);
    printf("Second element of dw6_output_32: %d\n", dw6_output_32[1][0][0]);
    printf("First element of dw6_output: %d\n", dw6_output[0][0][0]);
    printf("Second element of dw6_output: %d\n", dw6_output[1][0][0]);
    printf("Size of dw6_output: %d x %d x %d \n\n", LEN(dw6_output), LEN(dw6_output[0]), LEN(dw6_output[0][0]));
}

void pw6(){

    // Calculate the normalized pw6_multiplier
    const float pw6_multiplier = dw6_output_scale * pw6_weights_scale / pw6_output_scale;

    // Normalized fraction and exponent the pw6_multiplier
    float pw6_fraction;
    int pw6_exponent;
    frexp_function(pw6_multiplier, &pw6_fraction, &pw6_exponent);
    int pw6_fraction_int32 = pw6_fraction * (1ll << 31);
    printf("pw6_multiplier = %f = %d * 2^%d\n", pw6_multiplier, pw6_fraction_int32, pw6_exponent);

    int32_t pw6_output_32[pw6_output_size][pw6_output_size][pw6_weights_num];

    printf("Size of pw6_output_32: %d x %d x %d \n", LEN(pw6_output_32), LEN(pw6_output_32[0]), LEN(pw6_output_32[0][0]));

    //Perform pw6
    for(int k = 0; k < pw6_weights_num; k++){
        for(int i = 0; i < conv2d_6_output_size; i++){
            for(int j = 0; j < conv2d_6_output_size; j++){
                pw6_output_32[i][j][k] = 0;
                for(int l = 0; l < pw6_weights_channels; l++){
                    for(int m = 0; m < pw6_weights_size; m++){
                        for(int n = 0; n < pw6_weights_size; n++){
                            pw6_output_32[i][j][k] += dw6_output[i*pw6_weights_stride + m][j*pw6_weights_stride + n][l] * pw6_weights[m][n][l][k];
                        }
                    }
                }
                pw6_output_32[i][j][k] += pw6_biases[k];

                pw6_output_32[i][j][k] = fixed_point_multipilier(pw6_output_32[i][j][k], pw6_fraction_int32, pw6_exponent);

                // Cast to uint8_t
                pw6_output[i][j][k] = (uint8_t)pw6_output_32[i][j][k];

                // Add zero point
                pw6_output[i][j][k] = pw6_output[i][j][k] - pw6_output_zero_point;

                // Saturate
                if (pw6_output[i][j][k] < 0) {
                    pw6_output[i][j][k] = 0;
                } else if (pw6_output[i][j][k] > 255) {
                    pw6_output[i][j][k] = 255;
                }
            }
        }
    }
    printf("First element of pw6_output_32: %d\n", pw6_output_32[0][0][0]);
    printf("Second element of pw6_output_32: %d\n", pw6_output_32[1][0][0]);
    printf("First element of pw6_output: %d\n", pw6_output[0][0][0]);
    printf("Second element of pw6_output: %d\n", pw6_output[1][0][0]);
...
void add_4(){
    ...
    // Calculate the input and output new scale
    const float add_4_input_1_scale = 0.5;
    const int add_4_input_1_zero_point = pw6_output_scale;
    const float add_4_input_2_scale = add_3_output_scale / (2 * pw6_output_scale);
    const int add_4_input_2_zero_point = add_3_output_zero_point;
    const float add_4_output_scale_new = 2 * pw6_output_scale / add_4_output_scale;

    // Normalized fraction and exponent the add_4_input_1_scale
    float add_4_input_1_scale_fraction;
    int add_4_input_1_scale_exponent;
    frexp_function(add_4_input_1_scale, &add_4_input_1_scale_fraction, &add_4_input_1_scale_exponent);
    int add_4_input_1_scale_fraction_int32 = add_4_input_1_scale_fraction * (1ll << 31);
    printf("add_4_input_1_scale = %f = %d * 2^%d\n", add_4_input_1_scale, add_4_input_1_scale_fraction_int32, add_4_input_1_scale_exponent);

    // Normalized fraction and exponent the add_4_input_2_scale
    float add_4_input_2_scale_fraction;
    int add_4_input_2_scale_exponent;
    frexp_function(add_4_input_2_scale, &add_4_input_2_scale_fraction, &add_4_input_2_scale_exponent);
    int add_4_input_2_scale_fraction_int32 = add_4_input_2_scale_fraction * (1ll << 31);
    printf("add_4_input_2_scale = %f = %d * 2^%d\n", add_4_input_2_scale, add_4_input_2_scale_fraction_int32, add_4_input_2_scale_exponent);

    // Normalized fraction and exponent the add_4_output_scale_new
    float add_4_output_scale_new_fraction;
    int add_4_output_scale_new_exponent;    
    frexp_function(add_4_output_scale_new / (1 << 20), &add_4_output_scale_new_fraction, &add_4_output_scale_new_exponent);
    int add_4_output_scale_new_fraction_int32 = add_4_output_scale_new_fraction * (1ll << 31);
    printf("add_4_output_scale_new = %f = %d * 2^%d\n", add_4_output_scale_new, add_4_output_scale_new_fraction_int32, add_4_output_scale_new_exponent);
    
    // Define size of add_4_input_1, add_4_input_2, add_4_output_32
    int32_t add_4_input_1[add_4_output_size][add_4_output_size][add_4_output_channels];
    int32_t add_4_input_2[add_4_output_size][add_4_output_size][add_4_output_channels];
    int32_t add_4_output_32[add_4_output_size][add_4_output_size][add_4_output_channels];

    // Copy value of previous layers into add_4_input_1 and add_4_input_2
    for(int i = 0; i < add_4_output_size; i++){
        for(int j = 0; j < add_4_output_size; j++){
            for(int k = 0; k < add_4_output_channels; k++){
                add_4_input_1[i][j][k] = pw6_output[i][j][k];
                add_4_input_2[i][j][k] = add_3_output[i][j][k];
            }
        }
    }

    printf("add_4_input_1[%d][%d][%d] = %d\n", 0, 0, 0, add_4_input_1[0][0][0]);
    printf("add_4_input_1[%d][%d][%d] = %d\n", 1, 0, 0, add_4_input_1[1][0][0]);

    printf("add_4_input_2[%d][%d][%d] = %d\n", 0, 0, 0, add_4_input_2[0][0][0]);
    printf("add_4_input_2[%d][%d][%d] = %d\n", 1, 0, 0, add_4_input_2[1][0][0]);
    ...
    for(int i = 0; i < add_4_output_size; i++){
        for(int j = 0; j < add_4_output_size; j++){
            for(int k = 0; k < add_4_output_channels; k++){
                ...
                // Add zero point
                add_4_input_1[i][j][k] += add_4_input_1_zero_point;
                add_4_input_2[i][j][k] += add_4_input_2_zero_point;

                // Left shift the input
                add_4_input_1[i][j][k] = add_4_input_1[i][j][k] * (1 << 20);
                add_4_input_2[i][j][k] = add_4_input_2[i][j][k] * (1 << 20);

                // Fixed point multiplier
                add_4_input_1[i][j][k] = fixed_point_multipilier(add_4_input_1[i][j][k], add_4_input_1_scale_fraction_int32, add_4_input_1_scale_exponent);
                add_4_input_2[i][j][k] = fixed_point_multipilier(add_4_input_2[i][j][k], add_4_input_2_scale_fraction_int32, add_4_input_2_scale_exponent);
                add_4_output_32[i][j][k] = add_4_input_1[i][j][k] + add_4_input_2[i][j][k];

                // Fixed point multiplier
                add_4_output_32[i][j][k] = fixed_point_multipilier(add_4_output_32[i][j][k], add_4_output_scale_new_fraction_int32, add_4_output_scale_new_exponent);

                // Add zero point to add_4_output
                add_4_output_32[i][j][k] -= add_4_output_zero_point;

                // Saturate the output
                add_4_output[i][j][k] = saturate(add_4_output_32[i][j][k]);
            }
        }
    }
    printf("First element of add_4_output_32: %d\n", add_4_output_32[0][0][0]);
    printf("Second element of add_4_output_32: %d\n", add_4_output_32[1][0][0]);
    printf("First element of add_4_output: %d\n", add_4_output[0][0][0]);
    printf("Second element of add_4_output: %d\n", add_4_output[1][0][0]);
    printf("Size of add_4_output: %d x %d x %d \n\n", LEN(add_4_output), LEN(add_4_output[0]), LEN(add_4_output[0][0]));
}

void conv2d_7(){

    // Calculate the normalized conv2d_7_multiplier
    const float conv2d_7_multiplier = conv2d_7_weights_scale * add_4_output_scale / conv2d_7_output_scale;

    // Normalized fraction and exponent the conv2d_7_multiplier
    float conv2d_7_fraction;
    int conv2d_7_exponent;
    frexp_function(conv2d_7_multiplier, &conv2d_7_fraction, &conv2d_7_exponent);
    int conv2d_7_fraction_int32 = conv2d_7_fraction * (1ll << 31);
    printf("conv2d_7_multiplier = %f = %d * 2^%d\n", conv2d_7_multiplier, conv2d_7_fraction_int32, conv2d_7_exponent);

    int32_t conv2d_7_output_32[conv2d_7_output_size][conv2d_7_output_size][conv2d_7_weights_num];

    printf("First element of conv2d_7_weights: %d\n", conv2d_7_weights[0][0][0][0]);
    printf("Second element of conv2d_7_weights: %d\n", conv2d_7_weights[0][0][0][1]);

    //Perform conv2d_7
    for(int k = 0; k < conv2d_7_weights_num; k++){
        for(int i = 0; i < add_4_output_size; i++){
            for(int j = 0; j < add_4_output_size; j++){
                conv2d_7_output_32[i][j][k] = 0;
                for(int l = 0; l < conv2d_7_weights_channels; l++){
                    for(int m = 0; m < conv2d_7_weights_size; m++){
                        for(int n = 0; n < conv2d_7_weights_size; n++){
                            conv2d_7_output_32[i][j][k] += add_4_output[i*conv2d_7_weights_stride + m][j*conv2d_7_weights_stride + n][l] * conv2d_7_weights[m][n][l][k];
                        }
                    }
                }
                conv2d_7_output_32[i][j][k] += conv2d_7_biases[k];

                conv2d_7_output_32[i][j][k] = fixed_point_multipilier(conv2d_7_output_32[i][j][k], conv2d_7_fraction_int32, conv2d_7_exponent);

                // Cast to uint8_t
                conv2d_7_output[i][j][k] = (uint8_t)conv2d_7_output_32[i][j][k];

                // Add zero point
                conv2d_7_output[i][j][k] = conv2d_7_output[i][j][k] - conv2d_7_output_zero_point;

                // Saturate
                if (conv2d_7_output[i][j][k] < 0) {
                    conv2d_7_output[i][j][k] = 0;
                } else if (conv2d_7_output[i][j][k] > 255) {
                    conv2d_7_output[i][j][k] = 255;
                }
            }
        }
    }
    printf("First element of conv2d_7_output_32: %d\n", conv2d_7_output_32[0][0][0]);
    printf("Second element of conv2d_7_output_32: %d\n", conv2d_7_output_32[1][0][0]);
    printf("First element of conv2d_7_output: %d\n", conv2d_7_output[0][0][0]);
    printf("Second element of conv2d_7_output: %d\n", conv2d_7_output[1][0][0]);
    printf("Size of conv2d_7_output: %d x %d x %d \n\n", LEN(conv2d_7_output), LEN(conv2d_7_output[0]), LEN(conv2d_7_output[0][0]));
}

void dw7(){

    // Calculate the normalized dw7_multiplier
    const float dw7_multiplier = conv2d_7_output_scale * dw7_weights_scale / dw7_output_scale;

    // Normalized fraction and exponent the dw7_multiplier
    float dw7_fraction;
    int dw7_exponent;
    frexp_function(dw7_multiplier, &dw7_fraction, &dw7_exponent);
    int dw7_fraction_int32 = dw7_fraction * (1ll << 31);
    printf("dw7_multiplier = %f = %d * 2^%d\n", dw7_multiplier, dw7_fraction_int32, dw7_exponent);

    int32_t dw7_output_32[dw7_output_size][dw7_output_size][dw7_weights_channels];

    printf("First element of dw7_weights: %d\n", dw7_weights[0][0][0][0]);
    printf("Second element of dw7_weights: %d\n", dw7_weights[0][0][0][1]);
    ...
    for(int k = 0; k < dw7_weights_channels; k++){
        for(int i = 0; i < dw7_output_size; i++){
            for(int j = 0; j < dw7_output_size; j++){
                dw7_output_32[i][j][k] = 0;
                for(int l = 0; l < dw7_weights_size; l++){
                    for(int m = 0; m < dw7_weights_size; m++){
                        dw7_output_32[i][j][k] += conv2d_7_output_padded[i*dw7_weights_stride + l][j*dw7_weights_stride + m][k] * dw7_weights[l][m][k][0];
                    }
                }
                dw7_output_32[i][j][k] += dw7_biases[k];

                dw7_output_32[i][j][k] = fixed_point_multipilier(dw7_output_32[i][j][k], dw7_fraction_int32, dw7_exponent);

                // Cast to uint8_t
                dw7_output[i][j][k] = (uint8_t)dw7_output_32[i][j][k];

                // Add zero point 
                dw7_output[i][j][k] = dw7_output[i][j][k] - dw7_output_zero_point;

                // Saturate
                if (dw7_output[i][j][k] < 0) {
                    dw7_output[i][j][k] = 0;
                } else if (dw7_output[i][j][k] > 255) {
                    dw7_output[i][j][k] = 255;
                }
    ...
    printf("First element of dw7_output_32: %d\n", dw7_output_32[0][0][0]);
    printf("Second element of dw7_output_32: %d\n", dw7_output_32[1][0][0]);
    printf("First element of dw7_output: %d\n", dw7_output[0][0][0]);
    printf("Second element of dw7_output: %d\n", dw7_output[1][0][0]);
    printf("Size of dw7_output: %d x %d x %d \n\n", LEN(dw7_output), LEN(dw7_output[0]), LEN(dw7_output[0][0]));
}

void pw7(){

    // Calculate the normalized pw7_multiplier
    const float pw7_multiplier = dw7_output_scale * pw7_weights_scale / pw7_output_scale;

    // Normalized fraction and exponent the pw5_multiplier
    float pw7_fraction;
    int pw7_exponent;
    frexp_function(pw7_multiplier, &pw7_fraction, &pw7_exponent);
    int pw7_fraction_int32 = pw7_fraction * (1ll << 31);
    printf("pw7_multiplier = %f = %d * 2^%d\n", pw7_multiplier, pw7_fraction_int32, pw7_exponent);

    int32_t pw7_output_32[dw6_output_size][dw6_output_size][pw7_weights_num];

    printf("Size of pw7_output_32: %d x %d x %d \n", LEN(pw7_output_32), LEN(pw7_output_32[0]), LEN(pw7_output_32[0][0]));

    //Perform pw7
    for(int k = 0; k < pw7_weights_num; k++){
        for(int i = 0; i < pw7_output_size; i++){
            for(int j = 0; j < pw7_output_size; j++){
                pw7_output_32[i][j][k] = 0;
                for(int l = 0; l < pw7_weights_channels; l++){
                    for(int m = 0; m < pw7_weights_size; m++){
                        for(int n = 0; n < pw7_weights_size; n++){
                            pw7_output_32[i][j][k] += dw7_output[i][j][l] * pw7_weights[m][n][l][k];
                        }
                    }
                }
                pw7_output_32[i][j][k] += pw7_biases[k];

                pw7_output_32[i][j][k] = fixed_point_multipilier(pw7_output_32[i][j][k], pw7_fraction_int32, pw7_exponent);

                // Cast to uint8_t
                pw7_output[i][j][k] = (uint8_t)pw7_output_32[i][j][k];

                // Add zero point
                pw7_output[i][j][k] = pw7_output[i][j][k] - pw7_output_zero_point;

                // Saturate
                if (pw7_output[i][j][k] < 0) {
                    pw7_output[i][j][k] = 0;
                } else if (pw7_output[i][j][k] > 255) {
                    pw7_output[i][j][k] = 255;
                }
            }
        }
    }

    printf("First element of pw7_output_32: %d\n", pw7_output_32[0][0][0]);
    printf("Second element of pw7_output_32: %d\n", pw7_output_32[1][0][0]);
    printf("First element of pw7_output: %d\n", pw7_output[0][0][0]);
    printf("Second element of pw7_output: %d\n", pw7_output[1][0][0]);
    printf("Size of pw7_output: %d x %d x %d \n\n", LEN(pw7_output), LEN(pw7_output[0]), LEN(pw7_output[0][0]));
}

void conv2d_8(){

    // Calculate the normalized conv2d_8_multiplier
    const float conv2d_8_multiplier = conv2d_8_weights_scale * pw7_output_scale / conv2d_8_output_scale;

    // Normalized fraction and exponent the conv2d_8_multiplier
    float conv2d_8_fraction;
    int conv2d_8_exponent;
    frexp_function(conv2d_8_multiplier, &conv2d_8_fraction, &conv2d_8_exponent);
    int conv2d_8_fraction_int32 = conv2d_8_fraction * (1ll << 31);
    printf("conv2d_8_multiplier = %f = %d * 2^%d\n", conv2d_8_multiplier, conv2d_8_fraction_int32, conv2d_8_exponent);

    int32_t conv2d_8_output_32[conv2d_8_output_size][conv2d_8_output_size][conv2d_8_weights_num];

    printf("First element of conv2d_8_weights: %d\n", conv2d_8_weights[0][0][0][0]);
    printf("Second element of conv2d_8_weights: %d\n", conv2d_8_weights[0][0][0][1]);

    //Perform conv2d_8
    for(int k = 0; k < conv2d_8_weights_num; k++){
        for(int i = 0; i < conv2d_8_output_size; i++){
            for(int j = 0; j < conv2d_8_output_size; j++){
                conv2d_8_output_32[i][j][k] = 0;
                for(int l = 0; l < conv2d_8_weights_channels; l++){
                    for(int m = 0; m < conv2d_8_weights_size; m++){
                        for(int n = 0; n < conv2d_8_weights_size; n++){
                            conv2d_8_output_32[i][j][k] += pw7_output[i][j][l] * conv2d_8_weights[m][n][l][k];
                        }
                    }
                }
                conv2d_8_output_32[i][j][k] += conv2d_8_biases[k];

                conv2d_8_output_32[i][j][k] = fixed_point_multipilier(conv2d_8_output_32[i][j][k], conv2d_8_fraction_int32, conv2d_8_exponent);

                // Cast to uint8_t
                conv2d_8_output[i][j][k] = (uint8_t)conv2d_8_output_32[i][j][k];

                // Add zero point
                conv2d_8_output[i][j][k] = conv2d_8_output[i][j][k] - conv2d_8_output_zero_point;

                // Saturate
                if (conv2d_8_output[i][j][k] < 0) {
                    conv2d_8_output[i][j][k] = 0;
                } else if (conv2d_8_output[i][j][k] > 255) {
                    conv2d_8_output[i][j][k] = 255;
                }
            }
        }
    }

    printf("First element of conv2d_8_output_32: %d\n", conv2d_8_output_32[0][0][0]);
    printf("Second element of conv2d_8_output_32: %d\n", conv2d_8_output_32[1][0][0]);
    printf("First element of conv2d_8_output: %d\n", conv2d_8_output[0][0][0]);
    printf("Second element of conv2d_8_output: %d\n", conv2d_8_output[1][0][0]);
    printf("Size of conv2d_8_output: %d x %d x %d \n\n", LEN(conv2d_8_output), LEN(conv2d_8_output[0]), LEN(conv2d_8_output[0][0]));
}

void dw8(){

    // Calculate the normalized dw8_multiplier
    const float dw8_multiplier = conv2d_8_output_scale * dw8_weights_scale / dw8_output_scale;

    // Normalized fraction and exponent the dw8_multiplier
    float dw8_fraction;
    int dw8_exponent;
    frexp_function(dw8_multiplier, &dw8_fraction, &dw8_exponent);
    int dw8_fraction_int32 = dw8_fraction * (1ll << 31);
    printf("dw8_multiplier = %f = %d * 2^%d\n", dw8_multiplier, dw8_fraction_int32, dw8_exponent);

    int32_t dw8_output_32[dw8_output_size][dw8_output_size][dw8_weights_channels];

    // Initialize dw8_output_32 with 0 values
    for(int i = 0; i < dw8_output_size; i++){
        for(int j = 0; j < dw8_output_size; j++){
            for(int k = 0; k < dw8_weights_channels; k++){
                dw8_output_32[i][j][k] = 0;
            }
        }
    }

    printf("First element of dw8_weights: %d\n", dw8_weights[0][0][0][0]);
    printf("Second element of dw8_weights: %d\n", dw8_weights[0][0][0][1]);
    ...
    printf("Second element of conv2d_8_padded_output: %d\n", conv2d_8_padded_output[1][0][0]);
                ...
                for(int l = 0; l < dw8_weights_channels; l++){
                    for(int m = 0; m < dw8_weights_size; m++){
                        for(int n = 0; n < dw8_weights_size; n++){
                            dw8_output_32[i][j][l] += conv2d_8_padded_output[i + m][j + n][l] * dw8_weights[m][n][l][k];
                        }
                    }
                    dw8_output_32[i][j][l] += dw8_biases[l];

                    dw8_output_32[i][j][l] = fixed_point_multipilier(dw8_output_32[i][j][l], dw8_fraction_int32, dw8_exponent);

                    // Cast to uint8_t
                    dw8_output[i][j][l] = (uint8_t)dw8_output_32[i][j][l];

                    // Add zero point 
                    dw8_output[i][j][l] = dw8_output[i][j][l] - dw8_output_zero_point;

                    // Saturate
                    if (dw8_output[i][j][l] < 0) {
                        dw8_output[i][j][l] = 0;
                    } else if (dw8_output[i][j][l] > 255) {
                        dw8_output[i][j][l] = 255;
                    }
                }
            }
        }
    }
    printf("First element of dw8_output_32: %d\n", dw8_output_32[0][0][0]);
    printf("Second element of dw8_output_32: %d\n", dw8_output_32[1][0][0]);
    printf("First element of dw8_output: %d\n", dw8_output[0][0][0]);
    printf("Second element of dw8_output: %d\n", dw8_output[1][0][0]);
    printf("Size of dw8_output: %d x %d x %d \n\n", LEN(dw8_output), LEN(dw8_output[0]), LEN(dw8_output[0][0]));
}

void pw8(){

    // Calculate the normalized pw8_multiplier
    const float pw8_multiplier = dw8_output_scale * pw8_weights_scale / pw8_output_scale;

    // Normalized fraction and exponent the pw5_multiplier
    float pw8_fraction;
    int pw8_exponent;
    frexp_function(pw8_multiplier, &pw8_fraction, &pw8_exponent);
    int pw8_fraction_int32 = pw8_fraction * (1ll << 31);
    printf("pw8_multiplier = %f = %d * 2^%d\n", pw8_multiplier, pw8_fraction_int32, pw8_exponent);

    int32_t pw8_output_32[dw6_output_size][dw6_output_size][pw8_weights_num];

    printf("Size of pw8_output_32: %d x %d x %d \n", LEN(pw8_output_32), LEN(pw8_output_32[0]), LEN(pw8_output_32[0][0]));

    //Perform pw8
    for(int k = 0; k < pw8_weights_num; k++){
        for(int i = 0; i < pw8_output_size; i++){
            for(int j = 0; j < pw8_output_size; j++){
                pw8_output_32[i][j][k] = 0;
                for(int l = 0; l < pw8_weights_channels; l++){
                    for(int m = 0; m < pw8_weights_size; m++){
                        for(int n = 0; n < pw8_weights_size; n++){
                            pw8_output_32[i][j][k] += dw8_output[i + m][j + n][l] * pw8_weights[m][n][l][k];
                        }
                    }
                }
                pw8_output_32[i][j][k] += pw8_biases[k];

                pw8_output_32[i][j][k] = fixed_point_multipilier(pw8_output_32[i][j][k], pw8_fraction_int32, pw8_exponent);

                // Cast to uint8_t
                pw8_output[i][j][k] = (uint8_t)pw8_output_32[i][j][k];

                // Add zero point
                pw8_output[i][j][k] = pw8_output[i][j][k] - pw8_output_zero_point;

                // Saturate
                if (pw8_output[i][j][k] < 0) {
                    pw8_output[i][j][k] = 0;
                } else if (pw8_output[i][j][k] > 255) {
                    pw8_output[i][j][k] = 255;
                }
                printf("pw8_output[%d[%d][%d] = %d\n", i, j, k, pw8_output[i][j][k]);
            }
        }
    }
    printf("First element of pw8_output_32: %d\n", pw8_output_32[0][0][0]);
    printf("Second element of pw8_output_32: %d\n", pw8_output_32[1][0][0]);
    printf("First element of pw8_output: %d\n", pw8_output[0][0][0]);
    printf("Second element of pw8_output: %d\n", pw8_output[1][0][0]);
...
void add_5(){
    ...
    // Calculate the input and output new scale
    const float add_5_input_1_scale = 0.5;
    const int add_5_input_1_zero_point = pw8_output_scale;
    const float add_5_input_2_scale = pw7_output_scale / (2 * pw8_output_scale);
    const int add_5_input_2_zero_point = pw7_output_zero_point;
    const float add_5_output_scale_new = 2 * pw8_output_scale / add_5_output_scale;

    // Normalized fraction and exponent the add_5_input_1_scale
    float add_5_input_1_scale_fraction;
    int add_5_input_1_scale_exponent;
    frexp_function(add_5_input_1_scale, &add_5_input_1_scale_fraction, &add_5_input_1_scale_exponent);
    int add_5_input_1_scale_fraction_int32 = add_5_input_1_scale_fraction * (1ll << 31);
    printf("add_5_input_1_scale = %f = %d * 2^%d\n", add_5_input_1_scale, add_5_input_1_scale_fraction_int32, add_5_input_1_scale_exponent);

    // Normalized fraction and exponent the add_5_input_2_scale
    float add_5_input_2_scale_fraction;
    int add_5_input_2_scale_exponent;
    frexp_function(add_5_input_2_scale, &add_5_input_2_scale_fraction, &add_5_input_2_scale_exponent);
    int add_5_input_2_scale_fraction_int32 = add_5_input_2_scale_fraction * (1ll << 31);
    printf("add_5_input_2_scale = %f = %d * 2^%d\n", add_5_input_2_scale, add_5_input_2_scale_fraction_int32, add_5_input_2_scale_exponent);

    // Normalized fraction and exponent the add_5_output_scale_new
    float add_5_output_scale_new_fraction;
    int add_5_output_scale_new_exponent;    
    frexp_function(add_5_output_scale_new / (1 << 20), &add_5_output_scale_new_fraction, &add_5_output_scale_new_exponent);
    int add_5_output_scale_new_fraction_int32 = add_5_output_scale_new_fraction * (1ll << 31);
    printf("add_5_output_scale_new = %f = %d * 2^%d\n", add_5_output_scale_new, add_5_output_scale_new_fraction_int32, add_5_output_scale_new_exponent);
    
    // Define size of add_5_input_1, add_5_input_2, add_5_output_32
    int32_t add_5_input_1[add_5_output_size][add_5_output_size][add_5_output_channels];
    int32_t add_5_input_2[add_5_output_size][add_5_output_size][add_5_output_channels];
    int32_t add_5_output_32[add_5_output_size][add_5_output_size][add_5_output_channels];

    // Copy value of previous layers into add_5_input_1 and add_5_input_2
    for(int i = 0; i < add_5_output_size; i++){
        for(int j = 0; j < add_5_output_size; j++){
            for(int k = 0; k < add_5_output_channels; k++){
                add_5_input_1[i][j][k] = pw8_output[i][j][k];
                add_5_input_2[i][j][k] = pw7_output[i][j][k];
            }
        }
    }

    printf("add_5_input_1[%d][%d][%d] = %d\n", 0, 0, 0, add_5_input_1[0][0][0]);
    printf("add_5_input_1[%d][%d][%d] = %d\n", 1, 0, 0, add_5_input_1[1][0][0]);

    printf("add_5_input_2[%d][%d][%d] = %d\n", 0, 0, 0, add_5_input_2[0][0][0]);
    printf("add_5_input_2[%d][%d][%d] = %d\n", 1, 0, 0, add_5_input_2[1][0][0]);
    ...
    for(int i = 0; i < add_5_output_size; i++){
        for(int j = 0; j < add_5_output_size; j++){
            for(int k = 0; k < add_5_output_channels; k++){
                // Add zero point
                add_5_input_1[i][j][k] += add_5_input_1_zero_point;
                add_5_input_2[i][j][k] += add_5_input_2_zero_point;

                // Left shift the input
                add_5_input_1[i][j][k] = add_5_input_1[i][j][k] * (1 << 20);
                add_5_input_2[i][j][k] = add_5_input_2[i][j][k] * (1 << 20);

                // Fixed point multiplier
                add_5_input_1[i][j][k] = fixed_point_multipilier(add_5_input_1[i][j][k], add_5_input_1_scale_fraction_int32, add_5_input_1_scale_exponent);
                add_5_input_2[i][j][k] = fixed_point_multipilier(add_5_input_2[i][j][k], add_5_input_2_scale_fraction_int32, add_5_input_2_scale_exponent);
                add_5_output_32[i][j][k] = add_5_input_1[i][j][k] + add_5_input_2[i][j][k];

                // Fixed point multiplier
                add_5_output_32[i][j][k] = fixed_point_multipilier(add_5_output_32[i][j][k], add_5_output_scale_new_fraction_int32, add_5_output_scale_new_exponent);

                // Add zero point to add_5_output
                add_5_output_32[i][j][k] -= add_5_output_zero_point;

                // Saturate the output
                add_5_output[i][j][k] = saturate(add_5_output_32[i][j][k]);
            }
        }
    }

    printf("First element of add_5_output_32: %d\n", add_5_output_32[0][0][0]);
    printf("Second element of add_5_output_32: %d\n", add_5_output_32[1][0][0]);
    printf("First element of add_5_output: %d\n", add_5_output[0][0][0]);
    printf("Second element of add_5_output: %d\n", add_5_output[1][0][0]);
    printf("Size of add_5_output: %d x %d x %d \n\n", LEN(add_5_output), LEN(add_5_output[0]), LEN(add_5_output[0][0]));
}

void conv2d_9(){

    // Calculate the normalized conv2d_9_multiplier
    const float conv2d_9_multiplier = conv2d_9_weights_scale * add_5_output_scale / conv2d_9_output_scale;

    // Normalized fraction and exponent the conv2d_9_multiplier
    float conv2d_9_fraction;
    int conv2d_9_exponent;
    frexp_function(conv2d_9_multiplier, &conv2d_9_fraction, &conv2d_9_exponent);
    int conv2d_9_fraction_int32 = conv2d_9_fraction * (1ll << 31);
    printf("conv2d_9_multiplier = %f = %d * 2^%d\n", conv2d_9_multiplier, conv2d_9_fraction_int32, conv2d_9_exponent);

    int32_t conv2d_9_output_32[conv2d_9_output_size][conv2d_9_output_size][conv2d_9_weights_num];

    printf("First element of conv2d_9_weights: %d\n", conv2d_9_weights[0][0][0][0]);
    printf("Second element of conv2d_8_weights: %d\n", conv2d_9_weights[0][0][0][1]);

    //Perform conv2d_9
    for(int k = 0; k < conv2d_9_weights_num; k++){
        for(int i = 0; i < conv2d_9_output_size; i++){
            for(int j = 0; j < conv2d_9_output_size; j++){
                conv2d_9_output_32[i][j][k] = 0;
                for(int l = 0; l < conv2d_9_weights_channels; l++){
                    for(int m = 0; m < conv2d_9_weights_size; m++){
                        for(int n = 0; n < conv2d_9_weights_size; n++){
                            conv2d_9_output_32[i][j][k] += add_5_output[i + m][j + n][l] * conv2d_9_weights[m][n][l][k];
                        }
                    }
                }
                conv2d_9_output_32[i][j][k] += conv2d_9_biases[k];

                conv2d_9_output_32[i][j][k] = fixed_point_multipilier(conv2d_9_output_32[i][j][k], conv2d_9_fraction_int32, conv2d_9_exponent);

                // Cast to uint8_t
                conv2d_9_output[i][j][k] = (uint8_t)conv2d_9_output_32[i][j][k];

                // Add zero point
                conv2d_9_output[i][j][k] = conv2d_9_output[i][j][k] - conv2d_9_output_zero_point;

                // Saturate
                if (conv2d_9_output[i][j][k] < 0) {
                    conv2d_9_output[i][j][k] = 0;
                } else if (conv2d_9_output[i][j][k] > 255) {
                    conv2d_9_output[i][j][k] = 255;
                }
            }
        }
    }

    printf("First element of conv2d_9_output_32: %d\n", conv2d_9_output_32[0][0][0]);
    printf("Second element of conv2d_9_output_32: %d\n", conv2d_9_output_32[1][0][0]);
    printf("First element of conv2d_9_output: %d\n", conv2d_9_output[0][0][0]);
    printf("Second element of conv2d_9_output: %d\n", conv2d_9_output[1][0][0]);
